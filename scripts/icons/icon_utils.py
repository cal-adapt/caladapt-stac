...
import icon_constants  # sets font rcParams globally  # noqa: E402
from icon_constants import DPI
...
def make_icon_gif(
    ...
    title : str
        Small label overlaid in the top-right corner. Use {timestamp} as a placeholder.
    unit_label : str
    ...
    dpi = DPI
    fig_w, fig_h = width * 2 / dpi, height * 2 / dpi
