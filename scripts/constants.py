...
# PostgreSQL DSN for direct DB access (used for registering queryables)
# Stored as environment variable because it contains AWS credentials for RDS access
...
CLIM_PROF_GWL_PERIOD_DATES = {
    "present-day":      (datetime(2014, 1, 1, tzinfo=timezone.utc), datetime(2044, 12, 31, tzinfo=timezone.utc)),  # centered_year=2029
    "near-future":      (datetime(2025, 1, 1, tzinfo=timezone.utc), datetime(2055, 12, 31, tzinfo=timezone.utc)),  # centered_year=2040
    "mid-century":      (datetime(2038, 1, 1, tzinfo=timezone.utc), datetime(2068, 12, 31, tzinfo=timezone.utc)),  # centered_year=2053
    "mid-late-century": (datetime(2054, 1, 1, tzinfo=timezone.utc), datetime(2084, 12, 31, tzinfo=timezone.utc)),  # centered_year=2069
}
