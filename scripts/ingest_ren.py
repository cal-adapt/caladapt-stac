...
def build_pv_collection():
    ...
    collection = pystac.Collection(
        ...
        keywords=["climate model", "cloud-optimized", "renewable energy", "California", "capacity", "generation", "future projections", "CMIP6", "geospatial", "dynamical"],
...
def build_wind_collection():
    ...
    collection = pystac.Collection(
        ...
        keywords=["climate model", "cloud-optimized", "renewable energy", "California", "geospatial", "capacity", "generation", "future projections", "CMIP6", "dynamical"],
        extra_fields={"caladapt:spatial_type": "grid"},
